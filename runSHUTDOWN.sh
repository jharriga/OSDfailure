...
updatelog "BEGIN: OSDnode - rebooting" $LOGFILE
ssh "root@${OSDhostname}" reboot
...
echo " " | mail -s "ceph recovery complete" ekaynar@redhat.com jharriga@redhat.com frival@redhat.com
